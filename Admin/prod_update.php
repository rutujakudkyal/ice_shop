  ...
  if(isset($_POST['store'])){
    ...
    $price = $_POST['price'];
     ...
     if(!empty($_FILES['img']['name'])){
      ...
      $sql = "UPDATE product set cid='$cid', pname='$pname', desction='$desc', price='$price', img='$image_name' where id=$id";

       if(mysqli_query($con, $sql)){
        echo "<script>alert('record updated');
        window.location='prod_table.php';</script>";
       }
  }
?>
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label>Category</label>
                                                                 <select name="cid" class="form-control form-control-round" required>
                                                                    <option value="">Select Category</option>
                                                                        <?php
                                                                          $sql = "SELECT * FROM category";
                                                                          $res = mysqli_query($con, $sql);
                                                                          while ($rw = mysqli_fetch_assoc($res)) {
                                                                          $sel = ($rw['id'] == $row['cid']) ? "selected" : "";
                                                                          echo "<option value='{$rw['id']}' $sel>{$rw['cname']}</option>";
                                                                                                            }
                                                                         ?>
                                                                    </select>
                                                                </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text"  name="pname" class="form-control form-control-round" value="<?php echo $row['pname'];?>" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text"  name="price" class="form-control form-control-round" value="<?php echo $row['price'];?>" required>
                                                                </div>
                                                            </div>
