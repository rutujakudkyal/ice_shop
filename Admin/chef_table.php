                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0"> Category Table Display</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          if(isset($_GET['search']) && $_GET['search'] != "") {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                 <a href="chef_update.php?id=<?php echo $result[0]; ?>" 
                                                                    style="color:#BAF905;">
                                                                    Update</a>
                                                                </td>                                                              
                                                                <td><a href="chef_del.php?id=<?php echo $result[0]; ?>" style="color:#FB5959;"> Delete</a></td>
