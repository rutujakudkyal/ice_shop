    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <h1 class="section-title position-relative text-center mb-5">A Legacy of Sweet Perfection</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">About Us</h4>
                    <h5 class="text-muted mb-3">Dwarka Falooda & Ice Cream is a local favourite dessert destination in Solapur known for its ice creams, falooda, beverages, and dessert packs.</h5>
